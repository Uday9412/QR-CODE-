...
uday=tk.Tk()
uday.geometry("1400x800")
uday.title("QR code generator")
uday['bg']='#73a5ff'

text1=tk.Text(uday,wrap=tk.WORD,width=50,height=30,fg="white",bg="black")
